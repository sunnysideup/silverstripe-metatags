		...
		<table summary="update metatag overview" id="root">
			...
			<tfoot>
				<tr class="actions">
					...
					<% if SeparateMetaTitle %><th scope="col" class="metaT" title="The Page Title as it is 'seen' by search engines."><% if AlwaysUpdateMetaTitle %><img src="/metatags/images/linked.png" alt="linked" title="Meta  Title automatically updates to Page Title (linked)" /><% end_if %>Search Engine Title</th><% end_if %>
				...
				<tr class="actions subsequentActions">
					...
					<th class="batchactions">setup rules:</th>
				...
				<tr class="actions subsequentActions">
					...
					<th class="batchactions">Quick fixes:</th>
